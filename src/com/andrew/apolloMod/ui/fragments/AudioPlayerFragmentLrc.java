...
import com.andrew.apolloMod.ui.widgets.ChildViewPager;
 ...
 * @author Andrew Neal
 */
public class AudioPlayerFragmentLrc extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        root = inflater.inflate(R.layout.audio_player_lrc, container, false);
        ...
        mAlbumName = (TextView) root.findViewById(R.id.audio_player_album);
        mAlbumName.setOnClickListener(new OnClickListener() {
        ...
        mArtistName = (TextView) root.findViewById(R.id.audio_player_artists);
        mArtistName.setOnClickListener(new OnClickListener() {
