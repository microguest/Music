...
public class TrackAdapter extends SimpleCursorAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Track name
        String trackName = mCursor.getString(AudioPlayerFragmentList.mTitleIndex);
        viewholder.mViewHolderLineOne.setText(trackName);

        // Artist name
        String artistName = mCursor.getString(AudioPlayerFragmentList.mArtistIndex);
        ...
        long audioid = mCursor.getLong(AudioPlayerFragmentList.mMediaIdIndex);
